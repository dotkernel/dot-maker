...
class ImportTest extends TestCase
{
    ...
    {
        $import = new Import($this->context);
        $this->assertSame('Api\App\InputFilter\AbstractInputFilter', $import->getAbstractInputFilterFqcn());
    }
    ...
    {
        $import = new Import($this->context);
        $this->assertSame('Api\App\Repository\AbstractRepository', $import->getAbstractRepositoryFqcn());
    }

    public function testWillGetAppHelperPaginatorFqcn(): void
    {
        $import = new Import($this->context);
        $this->assertSame('Api\App\Helper\Paginator', $import->getAppHelperPaginatorFqcn());
    }

    public function testWillGetAppMessageFqcn(): void
    {
        $import = new Import($this->context);
        $this->assertSame('Api\App\Message', $import->getAppMessageFqcn());
    }
